 ...
 * 修改时间：暂无<br/>
 */
package com.sozone.eokb.fjs_sygc_tyb_v1;
 ...
 * @since 1.0.0
 */
@Path(value = "/fjs_sygc_tyb_v1/firstenvelope", desc = "第一信封解密服务接口")
// 登录即可访问
...
public class FirstEnvelope extends BaseAction
{
	 ...
	 * 项目CODE
	 */
	private final String PROJECT_CODE = ConstantEOKB.EOKBBemCode.FJS_SYGC_TYB_V1;

	/**
	 * 第一信封
	 */
	private final String FIRST_ENVELOPE = ConstantEOKB.EOKBFlowCode.FIRST_ENVELOPE;
			...
			throws FacadeException, IOException
	{
		...
		if (!SessionUtils.isBidder())
		{
			return new ModelAndView(getTheme(data.getHttpServletRequest())
					+ "/eokb/" + PROJECT_CODE + "/" + FIRST_ENVELOPE
