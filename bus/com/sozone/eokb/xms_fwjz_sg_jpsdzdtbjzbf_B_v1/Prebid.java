 ...
 * 修改时间：暂无<br/>
 */
package com.sozone.eokb.xms_fwjz_sg_jpsdzdtbjzbf_B_v1;
 ...
 * @since 1.0.0
 */
@Path(value = "/xms_fwjz_sg_jpsdzdtbjzbf_B_v1/prebid", desc = "评标前准备服务接口")
// 登录即可访问
...
public class Prebid extends BaseAction
{
	...
	private static String sqlName = ConstantEOKB.EOKBBemCode.XMS_FWJZ_SG_JPSDZDTBJZBF_B_V1
			+ "_prebid";
			...
			throws FacadeException
	{
		...
		return new ModelAndView(
				getTheme(data.getHttpServletRequest())
						+ "/eokb/xms_fwjz_sg_jpsdzdtbjzbf_B_v1/prebid/benchmark.index.html",
				model);
	}
			...
			throws FacadeException
	{
		...
		return new ModelAndView(
				getTheme(data.getHttpServletRequest())
						+ "/eokb/xms_fwjz_sg_jpsdzdtbjzbf_B_v1/prebid/benchmark.edit.html",
				model);
	}
	...
	public ModelAndView preTenderList(
			@PathParam("tpnid") String tenderProjectNodeID, AeolusData data)
			throws FacadeException, IOException
	{
		...
		return new ModelAndView(
				getTheme(data.getHttpServletRequest())
						+ "/eokb/xms_fwjz_sg_jpsdzdtbjzbf_B_v1/prebid/preTenderList.index.html",
				model);
	}
			...
			throws FacadeException, IOException
	{
		...
		return new ModelAndView(
				getTheme(data.getHttpServletRequest())
						+ "/eokb/xms_fwjz_sg_jpsdzdtbjzbf_B_v1/prebid/preTenderList.result.html",
				model);
	}
			...
			throws FacadeException, IOException
	{
		...
		return new ModelAndView(
				getTheme(data.getHttpServletRequest())
						+ "/eokb/xms_fwjz_sg_jpsdzdtbjzbf_B_v1/prebid/reviewTenderList.html",
				model);
	}
