 ...
 * 修改时间：暂无<br/>
 */
package com.sozone.eokb.xms_fwjz_sg_jpsdzdtbjzbf_B_v2;
 ...
 * @since 1.0.0
 */
@Path(value = "/xms_fwjz_sg_jpsdzdtbjzbf_B_v2/firstenvelope", desc = "第一信封解密服务接口")
// 登录即可访问
...
public class FirstEnvelope extends BaseAction
{
	 ...
	 * 项目CODE
	 */
	private final String projectCode = ConstantEOKB.EOKBBemCode.XMS_FWJZ_SG_JPSDZDTBJZBF_B_V2;
