/**
 * 包名：com.sozone.eokb.xms_fwjz_taxxm_tyb_v1
 * 文件名：Prebid.java<br/>
 ...
 * 修改时间：暂无<br/>
 */
package com.sozone.eokb.xms_fwjz_taxxm_tyb_v1;
 ...
 * @since 1.0.0
 */
@Path(value = "/xms_fwjz_taxxm_tyb_v1/prebid", desc = "评标前准备服务接口")
// 登录即可访问
...
public class Prebid
{
	 ...
	 * 项目CODE
	 */
	private static String projectCode = ConstantEOKB.EOKBBemCode.XMS_FWJZ_TAXXM_TYB_V1;
			...
			@PathParam("tpnoid") String tpnoid) throws ServiceException
	{
		...
		return new ModelAndView("/xms_fwjz/eokb/" + projectCode
