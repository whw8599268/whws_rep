 ...
 * 修改时间：暂无<br/>
 */
package com.sozone.eokb.fjs_gsgl_jgjg_ysqzljc_zhpff_v1;
 ...
 * @since 1.0.0
 */
@Path(value = "/fjs_gsgl_jgjg_ysqzljc_zhpff_v1/firstenvelope", desc = "第一信封解密服务接口")
// 登录即可访问
...
public class FirstEnvelope extends BaseAction
{
	 ...
	 * 项目CODE
	 */
	private static String projectCode = ConstantEOKB.EOKBBemCode.FJS_GSGL_JGJG_YSQZLJC_ZHPFF_V1;
	 ...
	 */
	// 定义路径
	@Path(value = "/credit/flow/{tpnid}", desc = "第一数字信封解密情况一览表")
	// GET访问方式
