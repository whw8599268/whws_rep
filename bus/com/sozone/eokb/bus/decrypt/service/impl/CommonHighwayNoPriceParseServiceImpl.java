 ...
 * 文件名：CommonHighwayNoPriceParseServiceImpl.java<br/>
 * 创建时间：2017-11-2 下午3:50:04<br/>
 * 创建者：zouye<br/>
 * 修改者：暂无<br/>
 * 修改简述：暂无<br/>
 * 修改详述：
...
/**
 * 普通公路没有投标报价的投标文件解析服务类<br/>
 * <p>
 * 专门针对综合评估法2那种没有投标报价的投标文件<br/>
 * </p>
 * Time：2017-11-2 下午3:50:04<br/>
 * 
 * @author zouye
 * @version 1.0.0
 * @since 1.0.0
 */
@Deprecated
public class CommonHighwayNoPriceParseServiceImpl extends
		CommonHighwayParseServiceImpl
{
	 ...
	 * 
	 * @see
	 * com.sozone.eokb.bus.decrypt.service.impl.CommonHighwayParseServiceImpl
