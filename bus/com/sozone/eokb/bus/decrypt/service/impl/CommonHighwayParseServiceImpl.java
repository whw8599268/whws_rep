 ...
 * 文件名：CommonHighwayParseServiceImpl.java<br/>
 * 创建时间：2017-10-31 上午9:40:50<br/>
 * 创建者：zouye<br/>
 * 修改者：暂无<br/>
 * 修改简述：暂无<br/>
 * 修改详述：
 ...
 */
@Deprecated
public class CommonHighwayParseServiceImpl extends
			...
			String unitfy, String orgCode) throws ServiceException
	{
		...
		if (SessionUtils.isSectionGroup())
		{
			return getActiveRecordDAO().statement().selectList(
					"decrypt.getCommonHighwayBidderDeliveryInfo", params);
		}
		return super.getBidderDeliveryInfo(tpid, unitfy, orgCode);
	}
