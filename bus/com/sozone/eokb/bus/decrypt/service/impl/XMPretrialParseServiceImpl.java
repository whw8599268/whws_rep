 ...
 * 文件名：XMPretrialParseServiceImpl.java<br/>
 * 创建时间：2018-1-15 下午3:25:21<br/>
 * 创建者：zouye<br/>
 * 修改者：暂无<br/>
 * 修改简述：暂无<br/>
 * 修改详述：
 ...
 */
@Deprecated
public class XMPretrialParseServiceImpl extends
		BidderDocumentParseServiceAdapter
{
			...
			throws ServiceException
	{
		...
		// 投标报价
		/*
		 * String tbbj = BidderElementParseUtils .getSingObjAttribute("tbbj",
		 * sings); if (StringUtils.isEmpty(tbbj)) { throw new
		 * ServiceException("", "无法获取到投标文件中的投标报价!"); } // 投标报价 double price =
		 * Double.parseDouble(tbbj); record.setColumn("N_PRICE", price);
		 */
		// 投标人编号
