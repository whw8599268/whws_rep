 ...
 * 文件名：HousingConstructionParseServiceImpl.java<br/>
 * 创建时间：2017-12-6 上午9:51:32<br/>
 * 创建者：zouye<br/>
 * 修改者：暂无<br/>
 * 修改简述：暂无<br/>
 * 修改详述：
 ...
 */
@Deprecated
public class HousingConstructionParseServiceImpl extends
		BidderDocumentParseServiceAdapter
{
			...
			String unifyCode, String type) throws ServiceException
	{
		...
		return getActiveRecordDAO().statement().selectOne(
				"ThreePartsDecrypt.getBidderCreditScore", param);
	}
