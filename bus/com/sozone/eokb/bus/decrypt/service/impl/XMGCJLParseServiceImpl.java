 ...
 * 文件名：XMGCJLParseServiceImpl.java<br/>
 * 创建时间：2018-5-15 上午10:33:12<br/>
 * 创建者：zouye<br/>
 * 修改者：暂无<br/>
 * 修改简述：暂无<br/>
 * 修改详述：
 ...
 */
@Deprecated
public class XMGCJLParseServiceImpl extends HousingConstructionParseServiceImpl
{
			...
			String unifyCode, String type) throws ServiceException
	{
		...
		Record<String, Object> result = getActiveRecordDAO().statement()
				.selectOne("ThreePartsDecrypt.getBidderCreditScore", param);
		if (null == result)
		{
