 ...
 * 文件名：NormalExpresswayParseServiceImpl.java<br/>
 * 创建时间：2017-10-31 上午10:45:06<br/>
 * 创建者：zouye<br/>
 * 修改者：暂无<br/>
 * 修改简述：暂无<br/>
 * 修改详述：
 ...
 * 高速公路投标文件解析实现<br/>
 * <p>
 * 使用与高速公路所有投标人编号与信用等级不相关联的范本
 * </p>
 * Time：2017-10-31 上午10:45:06<br/>
 * 
 * @author zouye
 * @version 1.0.0
 * @since 1.0.0
 */
@Deprecated
public class NormalExpresswayParseServiceImpl extends
		BidderDocumentParseServiceAdapter
{

	// TODO 适用于勘察设计、勘察监理、设计审查 、交竣工
