 ...
 * 修改时间：暂无<br/>
 */
package com.sozone.eokb.fjs_ptgl_gcsg_hldjfxyf_v2;
 ...
 * @since 1.0.0
 */
@Path(value = "/fjs_ptgl_gcsg_hldjfxyf_v2/secondenvelope", desc = "第二信封解密服务接口")
// 登录即可访问
...
public class SecondEnvelope extends BaseAction
{
	 ...
	 * 范本CODE
	 */
	private static String projectCode = ConstantEOKB.EOKBBemCode.FJS_PTGL_GCSG_HLDJFXYF_V2;
