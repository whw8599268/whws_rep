 ...
 * 修改时间：暂无<br/>
 */
package com.sozone.eokb.xms_szgc_sg_jpsdzdtbjzbf_B_v1;
 ...
 * @since 1.0.0
 */
@Path(value = "/xms_szgc_sg_jpsdzdtbjzbf_B_v1/prebid", desc = "评标前准备服务接口")
// 登录即可访问
...
public class Prebid extends BaseAction
{
	...
	private static String sqlName = ConstantEOKB.EOKBBemCode.XMS_SZGC_SG_JPSDZDTBJZBF_B_V1
			+ "_prebid";
	 ...
	 */
	// 定义路径
	@Path(value = "first/{tpnid}", desc = "保存K值结果")
	// PUT访问方式
	...
	public void saveKvalue(@PathParam("tpnid") String tenderProjectNodeID,
			AeolusData data) throws FacadeException
	{
		logger.debug(LogUtils.format("保存K值结果", tenderProjectNodeID, data));
		Record<String, Object> param = new RecordImpl<String, Object>();
			...
			throws FacadeException
	{
		...
		return new ModelAndView(
				getTheme(data.getHttpServletRequest())
						+ "/eokb/xms_szgc_sg_jpsdzdtbjzbf_B_v1/prebid/benchmark.index.html",
				model);
	}
			...
			throws FacadeException
	{
		...
		return new ModelAndView(
				getTheme(data.getHttpServletRequest())
						+ "/eokb/xms_szgc_sg_jpsdzdtbjzbf_B_v1/prebid/benchmark.edit.html",
				model);
	}
			...
			throws FacadeException
	{
		...
		for (Record<String, Object> section : sections)
		{
			...
			int method = FjszUtils.chouMethod(tpid, sectionId, "2");
		...
		return new ModelAndView(
				getTheme(data.getHttpServletRequest())
						+ "/eokb/xms_szgc_sg_jpsdzdtbjzbf_B_v1/prebid/preTenderList.index.html",
				model);
	}
			...
			throws FacadeException
	{
		...
		return new ModelAndView(
				getTheme(data.getHttpServletRequest())
						+ "/eokb/xms_szgc_sg_jpsdzdtbjzbf_B_v1/prebid/preTenderList.result.html",
				model);
	}
			...
			throws FacadeException
	{
		...
		return new ModelAndView(
				getTheme(data.getHttpServletRequest())
						+ "/eokb/xms_szgc_sg_jpsdzdtbjzbf_B_v1/prebid/reviewTenderList.html",
				model);
	}
			...
			AeolusData data) throws FacadeException
	{
		...
		list = tempList;
		page = new PageImpl<Record<String, Object>>(list, pageable, list.size());
		return page;
	}
