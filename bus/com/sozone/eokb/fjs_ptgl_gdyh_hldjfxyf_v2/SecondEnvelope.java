 ...
 * 修改时间：暂无<br/>
 */
package com.sozone.eokb.fjs_ptgl_gdyh_hldjfxyf_v2;
 ...
 * @since 1.0.0
 */
@Path(value = "/fjs_ptgl_gdyh_hldjfxyf_v2/secondenvelope", desc = "第二信封解密服务接口")
// 登录即可访问
...
public class SecondEnvelope extends BaseAction
{
	 ...
	 * 范本CODE
	 */
	private static String projectCode = ConstantEOKB.EOKBBemCode.FJS_PTGL_GDYH_HLDJFXYF_V2;
			...
			throws FacadeException, ParseException
	{
		...
		return new ModelAndView(
				getTheme(data.getHttpServletRequest())
						+ "/eokb/"+projectCode+"/secondEnvelope/second.record.view.html",
				model);
	}
