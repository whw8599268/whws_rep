 ...
 * 修改时间：暂无<br/>
 */
package com.sozone.eokb.xms_szgc_jl_zhpgf_v2;
 ...
 * @since 1.0.0
 */
@Path(value = "/xms_szgc_jl_zhpgf_v2/prebid", desc = "评标前准备服务接口")
// 登录即可访问
...
public class Prebid extends BaseAction
{
	 ...
	 * 项目CODE
	 */
	private static String projectCode = ConstantEOKB.EOKBBemCode.XMS_SZGC_JL_ZHPGF_V2;
	 ...
	 */
	// 定义路径
	@Path(value = "/method/flow/{tpnid}", desc = "打开抽取投标人页面")
	// GET访问方式
