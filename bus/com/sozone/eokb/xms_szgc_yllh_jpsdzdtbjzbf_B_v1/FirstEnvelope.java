 ...
 * @since 1.0.0
 */
@Path(value = "/xms_szgc_yllh_jpsdzdtbjzbf_B_v1/firstenvelope", desc = "第一信封解密服务接口")
// 登录即可访问
...
public class FirstEnvelope extends BaseAction
{
	 ...
	 * 项目CODE
	 */
	private final String projectCode = ConstantEOKB.EOKBBemCode.XMS_SZGC_YLLH_JPSDZDTBJZBF_B_V1;
