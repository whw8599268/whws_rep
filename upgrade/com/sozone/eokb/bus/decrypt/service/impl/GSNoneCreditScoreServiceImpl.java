 ...
 * 文件名：GSNoneCreditScoreServiceImpl.java<br/>
 * 创建时间：2018-5-16 上午9:22:09<br/>
 * 创建者：zouye<br/>
 * 修改者：暂无<br/>
 * 修改简述：暂无<br/>
 * 修改详述：
 ...
 * 高速公路不含信用分范本解析器<br/>
 * <p>
 * 高速公路所有投标人编号与信用等级不相关联的范本<br/>
 * 适用于勘察设计、勘察监理、设计审查 、交竣工
 * </p>
 * Time：2018-5-16 上午9:22:09<br/>
 * 
 * @author zouye
 * @version 1.0.0
 * @since 1.0.0
 */
public class GSNoneCreditScoreServiceImpl extends BidderDocumentServiceAdapter
{
			...
			throws ServiceException
	{
		...
		record.setColumn(
				"V_CORRELATE_CODE",
				getCorrelate(bidderDelivery.getString("V_UNIFY_CODE"),
						bidderDelivery.getString("V_ORG_CODE"),
