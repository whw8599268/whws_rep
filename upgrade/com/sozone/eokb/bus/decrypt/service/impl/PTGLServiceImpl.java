 ...
 * 文件名：PTGLServiceImpl.java<br/>
 * 创建时间：2018-5-16 上午9:31:36<br/>
 * 创建者：zouye<br/>
 * 修改者：暂无<br/>
 * 修改简述：暂无<br/>
 * 修改详述：
 ...
 * 普通公路投标文件解析服务类<br/>
 * </p>
 * Time：2018-5-16 上午9:31:36<br/>
 * 
 * @author zouye
 * @version 1.0.0
 * @since 1.0.0
 */
public class PTGLServiceImpl extends BidderDocumentServiceAdapter
{
			...
			String unitfy, String orgCode) throws ServiceException
	{
		...
		if (SessionUtils.isSectionGroup())
		{
			...
			return getActiveRecordDAO().statement().selectList(
					"DecryptV3.getPTGLDeliverys", params);
		}
		return super.getDeliveryDocuments(tpid, unitfy, orgCode);
	}
	 ...
	 * 
	 * @see com.sozone.eokb.bus.decrypt.service.BidderDocumentServiceAdapter#
	 * getDecryptTempDatas(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	protected List<Record<String, Object>> getDecryptTempDatas(String tpid,
			String unitfy, String orgCode) throws ServiceException
	{
		return super.getDecryptTempDatas(tpid, unitfy, orgCode);
	}
