 ...
 * 文件名：FJSZNoneCreditScoreServiceImpl.java<br/>
 * 创建时间：2018-5-16 上午10:15:55<br/>
 * 创建者：zouye<br/>
 * 修改者：暂无<br/>
 * 修改简述：暂无<br/>
 * 修改详述：
 ...
 * 不含信用分的房建市政解析实现<br/>
 * </p>
 * Time：2018-5-16 上午10:15:55<br/>
 * 
 * @author zouye
 * @version 1.0.0
 * @since 1.0.0
 */
public class FJSZNoneCreditScoreServiceImpl extends FJSZHasCreditScoreImpl
{
	...
	private static Logger logger = LoggerFactory
			.getLogger(FJSZNoneCreditScoreServiceImpl.class);
