...
<title>福建CA老版介质证书登录页-内网登录地址</title>
...
<script type="text/javascript">
	function login(type) {
		if (0 == type) {
			//招标人
			location.href = "${path}/authorize/o2c/auth?user_type=0&key=0&net_type=1";
		}
		if (1 == type) {
			//投标人
			location.href = "${path}/authorize/o2c/auth?user_type=1&key=0&net_type=1";
		}
	}
</script>
</head>
